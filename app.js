...
// apps.use(cors());
const allowedOrigins = ["https://cms-demo.kneks.go.id","https://demo.kneks.go.id","https://cms-dev.kneks.go.id","https://webdev.rifhandi.com","https://metabase.kneks.go.id","http://10.106.0.42:18950"];
apps.use(cors({
